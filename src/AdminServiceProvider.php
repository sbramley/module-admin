...
use TMS\Common\Commands\FooCommand;
use TMS\Common\Exceptions\InvalidConfiguration;
...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(LaravelPackageExample::class, function ($app) use ($config) {
     ...
     * @see  \KrisOzolins\LaravelPackageExample\Exceptions\InvalidConfiguration
     */
